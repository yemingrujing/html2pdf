package html2pdf.html2pdf.seal;
...
public abstract class SealUtil {
    ...
    public static BufferedImage buildSeal(SealConfiguration conf) throws Exception {
        ...
        //8.画中心字
        if (Objects.nonNull(conf.getCenterFont())) {
            if (conf.getCenterFont().getIsCircle()) {
                drawArcFont4Circle(g2d, borderCircleHeight, conf.getCenterFont(), true);
            } else {
